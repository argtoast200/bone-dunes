...
export const BIOME_DEFS = {
  ...
  jawBasin: {
    ...
    label: "Jaw Basin",
    shortLabel: "Basin",
    summary: "Predator basin ringed by crater walls and punishing drops, where heavy DNA rewards come with relentless territorial pressure.",
  ...
  emberRidge: {
    ...
    label: "Ember Ridge",
    shortLabel: "Ridge",
    summary: "High basalt mountains and ember vents where heavy bodies climb, leap, and survive brutal descents.",
